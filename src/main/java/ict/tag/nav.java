    ...
    private void seniorManagementNav(JspWriter out) throws IOException {
        out.println(
                "<nav class=\"navbar navbar-expand-lg sticky-top shadow-sm\" style=\"border-bottom: var(--bs-border-width) solid var(--bs-border-color); z-index: 1000; background-color: var(--bs-body-bg);\">"
                        ...
                        + "            <ul class=\"navbar-nav me-auto\">"
                        + "                <li class=\"nav-item\">"
                        + "                    <a class=\"nav-link\" href=\"/ITP4511_Project/page/seniorManagement/index.jsp\"><i class=\"material-icons small align-middle me-1\">home</i> Dashboard</a>"
                        + "                </li>"
                        + "                <li class=\"nav-item\">"
                        + "                    <a class=\"nav-link\" href=\"/ITP4511_Project/consumption\"><i class=\"material-icons small align-middle me-1\">bar_chart</i> Consumption Reports</a>"
                        + "                </li>"
                        + "                <li class=\"nav-item\">"
                        ...
                        + "                </li>"
                        + "                <li class=\"nav-item\">"
                        + "                    <a class=\"nav-link\" href=\"/ITP4511_Project/manageFruit\"><i class=\"material-icons small align-middle me-1\">category</i> Manage Fruit</a>"
                        + "                </li>"
                        + "                <li class=\"nav-item\">"
                        + "                    <a class=\"nav-link\" href=\"/ITP4511_Project/userList\"><i class=\"material-icons small align-middle me-1\">manage_accounts</i> User </a>"
                        + "                </li>"
                        + "                <li class=\"nav-item\">"
                        + "                    <a class=\"nav-link\" href=\"/ITP4511_Project/shopList\"><i class=\"material-icons small align-middle me-1\">storefront</i> Shop</a>"
                        + "                </li>"
                        + "                <li class=\"nav-item\">"
                        + "                    <a class=\"nav-link\" href=\"/ITP4511_Project/WarehouseList\"><i class=\"material-icons small align-middle me-1\">home</i> Warehouse</a>"
                        + "                </li>"
                        + "            </ul>"
                        + "            <div class=\"d-flex align-items-center\">"
                        + "                <div class=\"dropdown\">"
